        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="add_user.html" class="dropdown-item">Add Users</a>
                    <a href="manage_user.html" class="dropdown-item">Manage Users Users</a>
                </div>
            </div>
            <a href="product.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Product</a>
            <a href="orders.html" class="nav-item nav-link"><i class="fa fa-shopping-cart me-2"></i>Orders</a>
            <a href="payment.html" class="nav-item nav-link"><i class="fa fa-file-alt me-2"></i>Payment</a>
