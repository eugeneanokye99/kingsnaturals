<nav class="navbar navbar-expand bg-white navbar-dark sticky-top px-4 py-2">
    ...
    <form action="#" class="d-none d-md-flex ms-4">
        <input type="search" name="" id="" class="form-control border-0" style="background: #eee;" placeholder="Search">
    </form>
